...
public class ResponsavelResource {
	...
	// Criando responsavel
	@PostMapping
	public ResponseEntity<Responsavel> create(@Valid @RequestBody Responsavel obj){
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<ResponsavelDTO> update(@Valid @PathVariable Integer id, @RequestBody ResponsavelDTO objDto) {
